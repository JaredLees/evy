...
import com.evy.core.bean.Admin;
...
public interface AdminMapper {
    ...
    @Insert({
        ...
        "username, password, ",
        "credentials_salt, nickname, ",
        "realname, pinyin, ",
        "telephone, mobile, ",
        "email, QQ, status, ",
        "last_login_time, last_login_ip, ",
        "last_logout_time, this_login_time, ",
        "this_login_ip, check_mail, ",
        "check_mobile, remark, ",
        "create_time, modify_time, ",
        "delete)",
        "values (#{id,jdbcType=BIGINT}, #{accountId,jdbcType=BIGINT}, ",
        "#{username,jdbcType=VARCHAR}, #{password,jdbcType=VARCHAR}, ",
        "#{credentialsSalt,jdbcType=VARCHAR}, #{nickname,jdbcType=VARCHAR}, ",
        "#{realname,jdbcType=VARCHAR}, #{pinyin,jdbcType=VARCHAR}, ",
        "#{telephone,jdbcType=VARCHAR}, #{mobile,jdbcType=VARCHAR}, ",
        "#{email,jdbcType=VARCHAR}, #{qq,jdbcType=VARCHAR}, #{status,jdbcType=CHAR}, ",
        "#{lastLoginTime,jdbcType=TIMESTAMP}, #{lastLoginIp,jdbcType=VARCHAR}, ",
        "#{lastLogoutTime,jdbcType=TIMESTAMP}, #{thisLoginTime,jdbcType=TIMESTAMP}, ",
        "#{thisLoginIp,jdbcType=VARCHAR}, #{checkMail,jdbcType=CHAR}, ",
        "#{checkMobile,jdbcType=CHAR}, #{remark,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, account_id, username, password, credentials_salt, nickname, realname, pinyin, ",
        "telephone, mobile, email, QQ, status, last_login_time, last_login_ip, last_logout_time, ",
